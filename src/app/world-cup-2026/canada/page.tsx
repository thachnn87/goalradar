...
const TEAM = WC_TEAMS.canada;
const BASE_URL = 'https://goalradar.org';
const PAGE_URL = `${BASE_URL}/world-cup-2026/${TEAM.slug}`;

export const metadata: Metadata = {
  title: 'Canada FIFA World Cup 2026 – Schedule, Squad & Live Scores | GoalRadar',
  description: TEAM.metaDescription,
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Canada – FIFA World Cup 2026 | GoalRadar',
    description: TEAM.metaDescription,
    type: 'website',
    url: PAGE_URL,
  },
...
export default function CanadaTeamPage() {
