...
const KNOCKOUT_COMPACT: [
  ...
  ['LAST_32', 1,  '2026-06-28', '17:00', 'los-angeles',     'Inglewood, CA',        '1st Group E',  '3rd (A/B/C/D/F)'],
  ['LAST_32', 2,  '2026-06-29', '21:00', 'boston',          'Foxborough, MA',       '1st Group I',  '3rd (C/D/F/G/H)'],
  ['LAST_32', 3,  '2026-06-29', '17:00', 'metlife-stadium', 'East Rutherford, NJ',  '2nd Group A',  '2nd Group B'],
  ['LAST_32', 4,  '2026-06-29', '21:00', 'dallas',          'Arlington, TX',        '1st Group F',  '2nd Group C'],
  ['LAST_32', 5,  '2026-06-30', '17:00', 'seattle',         'Seattle, WA',          '2nd Group K',  '2nd Group L'],
  ['LAST_32', 6,  '2026-06-30', '21:00', 'atlanta',         'Atlanta, GA',          '1st Group H',  '2nd Group J'],
  ['LAST_32', 7,  '2026-06-30', '17:00', 'miami',           'Miami Gardens, FL',    '1st Group D',  '3rd (B/E/F/I/J)'],
  ['LAST_32', 8,  '2026-07-01', '21:00', 'kansas-city',     'Kansas City, MO',      '1st Group G',  '3rd (A/E/H/I/J)'],
  ['LAST_32', 9,  '2026-07-01', '17:00', 'philadelphia',    'Philadelphia, PA',     '1st Group C',  '2nd Group F'],
  ['LAST_32', 10, '2026-07-01', '21:00', 'san-francisco',   'Santa Clara, CA',      '2nd Group E',  '2nd Group I'],
  ['LAST_32', 11, '2026-07-02', '17:00', 'houston',         'Houston, TX',          '1st Group A',  '3rd (C/E/F/H/I)'],
  ['LAST_32', 12, '2026-07-02', '21:00', 'guadalajara',     'Guadalajara',          '1st Group L',  '3rd (E/H/I/J/K)'],
  ['LAST_32', 13, '2026-07-02', '17:00', 'mexico-city',     'Mexico City',          '1st Group J',  '2nd Group H'],
  ['LAST_32', 14, '2026-07-03', '21:00', 'monterrey',       'Monterrey',            '2nd Group D',  '2nd Group G'],
  ['LAST_32', 15, '2026-07-03', '17:00', 'toronto',         'Toronto, ON',          '1st Group B',  '3rd (E/F/G/I/J)'],
  ['LAST_32', 16, '2026-07-03', '21:00', 'vancouver',       'Vancouver, BC',        '1st Group K',  '3rd (D/E/I/J/L)'],

  // ── Round of 16 (July 4-7) ────────────────────────────────────────────
  ['LAST_16', 1,  '2026-07-04', '17:00', 'metlife-stadium', 'East Rutherford, NJ', 'Winner R32 M1',  'Winner R32 M2'],
  ['LAST_16', 2,  '2026-07-04', '21:00', 'dallas',          'Arlington, TX',        'Winner R32 M3',  'Winner R32 M4'],
  ['LAST_16', 3,  '2026-07-05', '17:00', 'los-angeles',     'Inglewood, CA',        'Winner R32 M5',  'Winner R32 M6'],
  ['LAST_16', 4,  '2026-07-05', '21:00', 'miami',           'Miami Gardens, FL',    'Winner R32 M7',  'Winner R32 M8'],
  ['LAST_16', 5,  '2026-07-06', '17:00', 'boston',          'Foxborough, MA',       'Winner R32 M9',  'Winner R32 M10'],
  ['LAST_16', 6,  '2026-07-06', '21:00', 'seattle',         'Seattle, WA',          'Winner R32 M11', 'Winner R32 M12'],
  ['LAST_16', 7,  '2026-07-06', '17:00', 'atlanta',         'Atlanta, GA',          'Winner R32 M13', 'Winner R32 M14'],
  ['LAST_16', 8,  '2026-07-07', '21:00', 'san-francisco',   'Santa Clara, CA',      'Winner R32 M15', 'Winner R32 M16'],

  // ── Quarter-finals (July 9-11) — official FIFA 2026 dates & venues ────
  ['QUARTER_FINALS', 1, '2026-07-09', '18:00', 'boston',      'Foxborough, MA',    'Winner R16 M1', 'Winner R16 M2'],
  ['QUARTER_FINALS', 2, '2026-07-10', '22:00', 'los-angeles', 'Inglewood, CA',     'Winner R16 M3', 'Winner R16 M4'],
  ['QUARTER_FINALS', 3, '2026-07-11', '18:00', 'miami',       'Miami Gardens, FL', 'Winner R16 M5', 'Winner R16 M6'],
  ['QUARTER_FINALS', 4, '2026-07-11', '22:00', 'kansas-city', 'Kansas City, MO',   'Winner R16 M7', 'Winner R16 M8'],

  // ── Semi-finals (July 14-15) — official FIFA 2026 dates & venues ──────
  ['SEMI_FINALS', 1, '2026-07-14', '21:00', 'dallas',  'Arlington, TX', 'Winner QF1',  'Winner QF2'],
  ['SEMI_FINALS', 2, '2026-07-15', '21:00', 'atlanta', 'Atlanta, GA',   'Winner QF3',  'Winner QF4'],

  // ── Third-place play-off (July 18) ────────────────────────────────────
  ['THIRD_PLACE', 1, '2026-07-18', '18:00', 'miami', 'Miami Gardens, FL', 'Loser SF1', 'Loser SF2'],

  // ── Final (July 19 — MetLife Stadium) ────────────────────────────────
  // Dates & venues verified against the official FIFA 2026 match schedule
  // (knockout stage 28 June – 19 July). The Final is at MetLife Stadium.
  ['FINAL',       1, '2026-07-19', '20:00', 'metlife-stadium', 'East Rutherford, NJ', 'Winner SF1', 'Winner SF2'],
];
